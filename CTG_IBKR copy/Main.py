...
from DataHandler import YahooDataHandler, HistoricCSVDataHandler, IBKRDataHandler
from Execution import SimpleSimulatedExecutionHandler, IBKRExecutionHandler
...
if __name__ == "__main__":
    ...
    backtest = Backtest(data_dir          = data_dir,  # data directory of CSV files
                        ...
                        strategy          = CointegratedPair # strategy chosen
    )  
